...
const adminRoutes = [
  ...
  { id: 5, path: '/admin/settings', text: 'Settings', Icon: IoSettingsOutline }
];
...
const employeeRoutes = [
  ...
  { id: 5, path: '/employee/settings', text: 'Settings', Icon: IoSettingsOutline }
];
  ...
  return (
    <div className="sidebar w-65 bg-linear-to-b from-[#0F172B] via-[#0F172B] to-[#020618] border-r border-white/4 text-white flex flex-col">
      ...
      <div className="bg-[#171E32] flex items-center gap-3 py-4 px-3 rounded-md mx-3 mt-4 border border-white/4">
        <div className="username size-9 rounded-md bg-[#1E2A3E] flex justify-center items-center text-[#90A1B9] font-semibold text-xs"> A </div>
        <div>
          <h3 className="text-sm font-medium"> John Doe </h3>
          <p className="text-xs text-[#62748E]"> Employee </p>
        </div>
      </div>
