...
import type { PayslipHeaderProps } from "../types/payslip.types";

const PayslipHeader = ({ setShowModal, description, title, isAdmin = true }: PayslipHeaderProps) => {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">

      <div className="space-y-1">
        <h1 className="text-2xl font-medium text-[#0F172B]"> {title} </h1>
